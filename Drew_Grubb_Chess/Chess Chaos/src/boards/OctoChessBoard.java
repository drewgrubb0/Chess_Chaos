...
public class OctoChessBoard extends Board
{
	...
	{	
		...
		setPiece(new Position(2, 1), new Knight(Piece.BLACK));
		setPiece(new Position(2, 6), new Knight(Piece.WHITE));
		setPiece(new Position(5, 1), new Knight(Piece.BLACK));
		setPiece(new Position(5, 6), new Knight(Piece.WHITE));
		...
		setPiece(new Position(3, 2), new Pawn(Piece.BLACK));
		setPiece(new Position(3, 5), new Pawn(Piece.WHITE));
